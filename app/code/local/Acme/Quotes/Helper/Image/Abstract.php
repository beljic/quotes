 ...
 */
abstract class Acme_Quotes_Helper_Image_Abstract extends Mage_Core_Helper_Data
{
    /**
     ...
     * @return Acme_Quotes_Helper_Image_Abstract
     ...
     * @access public
     * @param bool $value
     * @return mixed(bool|Acme_Quotes_Helper_Image_Abstract)
